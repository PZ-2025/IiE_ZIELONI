...
VALUES (
    ...
    '2020-01-01',
    'admin',
    -- Hasło "admin" zahashowane bcrypt
    'admin',
    NOW()
);
...
-- Zespół 3 (mkowalczyk -> rkozlowski)
